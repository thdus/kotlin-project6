...
class AddActivity() : AppCompatActivity(), Parcelable {
    private lateinit var binding: ActivityAddBinding
    private var originWord: Word? = null

    constructor(parcel: Parcel) : this() {
        originWord = parcel.readParcelable(Word::class.java.classLoader)
    }
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        parcel.writeParcelable(originWord, flags)
    }
    ...
    companion object CREATOR : Parcelable.Creator<AddActivity> {
        override fun createFromParcel(parcel: Parcel): AddActivity {
            return AddActivity(parcel)
        }

        override fun newArray(size: Int): Array<AddActivity?> {
